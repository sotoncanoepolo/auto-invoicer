...
function waitForFormAndInitialize() {
  ...
  window.addEventListener('csvDataReady', (event) => {
    ...
    setEmailContent('Hi,<br>Thank you for your recent interaction with SUHPA. Please make this payment as soon as possible- Thanks :)<br>If you have any questions, please contact the committee at <a href="mailto:suhpa@soton.ac.uk?subject=Query%20MH%20Payment%20Request&body=Dear SUHPA Treasurer,">SUHPA@soton.ac.uk</a>.<br>Best wishes,<br>SUHPA Committee<br><br>---<br>This is an automated message sponsored by Canoe Polo.');
